...
import ModernImageRenderer from "../../../Shared/renderers/ImageRenderer";
    ...
    <div className="modern-file-viewer">
                ...
                <div className="border-t border-github-border mt-1 pt-1">
                  ...
                  {availableThemes.map((theme) => (
                    ...
                    >
                      ...
                      {syntaxTheme === theme.id && (
                        <span className="ml-auto text-sm text-github-text-secondary">
                          ✓
                        </span>
                      )}
                    </button>
      ...
      <div className="overflow-hidden">
        {fileViewLoading ? (
          ...
          <div className="p-6 bg-red-900/20 text-red-400">{fileViewError}</div>
        ) : fileContent ? (
