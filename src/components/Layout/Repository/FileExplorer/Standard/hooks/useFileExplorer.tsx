...
export const FileExplorerContext = createContext<FileExplorerContextType>(enhancedContext);
...
interface FileExplorerProviderProps {
    children: ReactNode;
    value: Omit<FileExplorerContextType, 'formatBytes' | 'getFileLanguage' | 'isMarkdown' | 'isImage'>;
}

export function FileExplorerProvider({ children, value }: FileExplorerProviderProps) {
