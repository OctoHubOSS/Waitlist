    ...
    <div className="container mx-auto px-4 py-12">
      <div className="mb-10">
        ...
        <p className="text-muted-foreground max-w-2xl">
          Stay updated with the latest changes and feature releases of OctoHub.
        </p>
      </div>
          ...
          {changelogs.map((changelog) => {
            ...
            return (
              <div
                ...
                className="p-6 transition-colors border rounded-lg bg-background/50 hover:bg-background/80"
              >
                ...
                <div
                  ...
                  dangerouslySetInnerHTML={{
                    __html: changelog.formattedBody,
                  }}
                />
