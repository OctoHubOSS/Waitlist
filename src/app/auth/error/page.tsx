  ...
  const errorMessages: Record<string, { title: string; description: string }> =
    {
      ...
      Verification: {
        ...
        description:
          "The verification link may have expired or has already been used. Please request a new verification link.",
      },
      OAuthSignin: {
        title: "OAuth Sign In Error",
        description:
          "There was an error initializing the OAuth sign-in process.",
      },
      OAuthCallback: {
      ...
      Callback: {
        ...
        description:
          "There was an error during the authentication callback process.",
      },
      Default: {
      ...
      >
        ...
        <div className="mt-8 text-sm text-github-text-secondary">
          <p>
            Need help?{" "}
            <a
              href="mailto:support@octosearch.dev"
