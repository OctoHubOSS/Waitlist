                        ...
                        <form onSubmit={handleUnsubscribe} className="space-y-6">
                            ...
                            <div>
                                <button
                                    ...
                                    className={`w-full flex justify-center items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-github-accent hover:bg-github-accent/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-github-accent ${isUnsubscribing ? 'opacity-70 cursor-not-allowed' : ''
                                        }`}
                                >
                                    {isUnsubscribing ? (
                                        <>
