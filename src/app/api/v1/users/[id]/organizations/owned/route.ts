...
// GET /api/base/users/[id]/organizations/owned
export async function GET(
    ...
    try {
        ...
        const { take = 30, skip = 0, sort = 'name', order = 'asc', search } = validation.data;
        ...
        return paginatedResponse(
            ...
            take,
            total,
            'User owned organizations retrieved successfully'
        );
    } catch (error) {
